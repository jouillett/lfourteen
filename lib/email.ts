    ...
    <div style="padding:40px 24px 48px 24px;">
      ...
      <div style="margin-bottom:32px;text-align:center;">
        <a href="https://lfourteen.life/mypage/order" style="text-decoration:none;">
          <img src="https://capofcom.mycafe24.com/l14_coordy/images/l14bill.jpg" alt="엘포틴 코디 제품" width="300" style="max-width:100%;height:auto;display:inline-block;border-radius:8px;" />
        </a>
      </div>
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td style="vertical-align:middle;">
            <p style="margin:0 0 4px 0;font-size:11px;color:#888888;line-height:1.6;">대표 조민균 | 사업자등록번호: 691-23-02249</p>
            <p style="margin:0 0 4px 0;font-size:11px;color:#888888;line-height:1.6;">문의전화: 010-2115-2249</p>
