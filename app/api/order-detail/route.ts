    ...
    try {
      ...
      if (processedItems.length === 0) {
        ...
        processedItems.push({
          ...
          product_image: 'https://capofcom.mycafe24.com/l14_coordy/images/l14cordy.jpg?v=3',
          product_bill_image: 'https://capofcom.mycafe24.com/l14_coordy/images/l14bill.jpg?v=3',
